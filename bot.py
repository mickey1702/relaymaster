...
def add_route(message):
    ...
    try:
        ...
        new_route = {"source_chat": source_chat, "source_topic": source_topic, "dest_chat": dest_chat, "dest_topic": dest_topic}
        ...
        for route in ROUTES:
            ...
            try:
                if route["dest_topic"] is not None:
                    sent = bot.copy_message(chat_id=route["dest_chat"], from_chat_id=src_chat, message_id=message.message_id, message_thread_id=route["dest_topic"])
                else:
                    sent = bot.copy_message(chat_id=route["dest_chat"], from_chat_id=src_chat, message_id=message.message_id)
